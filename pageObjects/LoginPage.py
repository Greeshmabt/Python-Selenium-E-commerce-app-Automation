...
class Loginpage(BrowserUtils):     #inheritance from parent class

    def __init__(self, driver):    #initializing current class
        super().__init__(driver)   #initializing parent class as well ie BrowserUtils
        self.driver = driver
        self.username_input= (By.NAME, "name")   #placing all my locators inside constructor method
    ...
    def login(self, username, email, password, DOB, gender): #taking these parameter values from E2E class
